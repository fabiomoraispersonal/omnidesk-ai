...
- [ ] T188 Executar manualmente `specs/009-tickets-crm/quickstart.md` QS1–QS13 em ambiente dev. Documentar resultados em `specs/009-tickets-crm/quickstart-evidences.md` (padrão Spec 007). Marca SCs validados — **REABERTA 2026-05-12**: arquivo `quickstart-evidences.md` nunca foi criado. Requer Docker + stack dev (Postgres + Redis + Mongo + MinIO) + CRM rodando. Bloquear merge para `main` enquanto não rodar.
