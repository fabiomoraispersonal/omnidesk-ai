...
/// <summary>Spec 011 T049 — FluentValidation para atualização de profissional.</summary>
public class UpdateProfessionalValidator : AbstractValidator<UpdateProfessionalValidator.Request>
{
